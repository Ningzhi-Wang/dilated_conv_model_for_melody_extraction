...
from self_defined.array_to_tf_table import ArrayToTableTFFn
from self_defined.is_vocals import is_vocals_m2m3_fn
from self_defined.is_vocals import is_vocals_singer_fn
try:
    from self_defined.torch_bce_tf_style import torch_bce_tf_style_fn
    from self_defined.torch_bce_tf_style import pytorch_set_shape_fn
